...
README-->
*/
import { IidCard, IisIdCard } from '../../../typings/regModules'

const isIdCard: IisIdCard = (idCard: IidCard): boolean => {
  ...
  // 取身份证前两位,校验省份
  function checkProvince(card: string, vcity: { [key: string]: string }) {

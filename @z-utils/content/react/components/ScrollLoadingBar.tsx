...
<d:无限滚动触发块>
<d:直接链接触发事件即可>
<d:需要在触发事件内结束时 赋值 infinityScrolling.bol = true>
```javascript
<p:
...
export default class ScrollLoadingBar extends Component<Props> {
  ...
  componentWillUnmount() {
    if(this.infinityScrolling.closeMonitor){
   ...
   * })
   */
  infinityScrolling: IinfinityScrolling= function(dom: HTMLElement, cb: Function) {
    let that = this
    let throttleFn: any
